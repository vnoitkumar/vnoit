  ...
  return (
    <footer className="mx-auto mt-48 flex max-w-7xl items-center justify-between p-6 lg:px-8">
      ...
      <div className="flex gap-1">
        <a href="mailto:vnoitkumar@gmail.com" className="p-2">
          <svg
            viewBox="0 0 24 24"
            className="fill-custom-black/60 hover:fill-custom-black dark:fill-baby-powder/60 dark:hover:fill-baby-powder h-5 w-5"
          >
