      ...
      <div className="flex flex-col gap-4 items-center justify-center text-center">
        {/* <div className="flex w-full justify-center item-center md:mb-3">
          <div className="hidden md:flex gap-2.5 justify-start items-center h-12 px-7 py-3.5 rounded-3xl border border-custom-black/15 dark:border-baby-powder/15">
            <Link
              className="text-custom-black/80 dark:text-baby-powder/80 text-base font-medium"
              href="/"
            >
              Blog
            </Link>
            <Arrow />
            <span className="text-custom-black/80 dark:text-baby-powder/80 text-base font-medium">
              Posts
            </span>
            <Arrow />
        ...
        <div className="justify-center items-center gap-4 flex flex-col md:flex-row">
          <div className="justify-start items-center gap-2 flex">
            ...
            <div className="text-custom-black/80 dark:text-baby-powder/80 text-sm">
              {/* {author.name} -  */}
  ...
  function Arrow() {
    return (
      <svg
        ...
        height={12}
        viewBox="0 0 8 12"
        className="fill-custom-black/80 dark:fill-baby-powder/80"
      >
