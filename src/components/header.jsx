  ...
  return (
    <header className="bg-baby-powder dark:bg-custom-black">
      ...
      >
        ...
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-baby-powder border-t border-gray-200 dark:bg-custom-black dark:border-gray-600 block lg:hidden">
            ...
            <MobileMenuItem
              ...
              icon={
                <svg
                  ...
                  fill="currentColor"
                  className="w-7 h-7 mb-1 text-custom-black/80 dark:text-baby-powder/80 group-hover:text-light-sea-green dark:group-hover:text-light-sea-green"
                >
